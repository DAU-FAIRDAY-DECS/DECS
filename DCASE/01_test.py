...
if __name__ == "__main__":
    ...
    for idx, target_dir in enumerate(dirs):
        ...
        print("============== MODEL LOAD ==============")
        # load model file
        model_file = "{model}/model_{machine_type}_100_64.keras".format(model=param["model_directory"],
        ...
        anomaly_score_csv = "{result}/anomaly_score_{machine_type}_{dir_name}.csv".format(result=param["result_directory"],
                                                                                                        machine_type=machine_type,
                                                                                                        dir_name=dir_name)
        anomaly_score_list = []

        # setup decision result file path
        decision_result_csv = "{result}/decision_result_{machine_type}_{dir_name}.csv".format(result=param["result_directory"],
                                                                                                            machine_type=machine_type,
                                                                                                            dir_name=dir_name)
        ...
        #     csv_lines.append([auc_s, auc_t, p_auc, prec_s, prec_t, recall_s, recall_t, f1_s, f1_t])
